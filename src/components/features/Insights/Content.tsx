 ...
 * Content
 *
 * Renderiza o diagnóstico financeiro gerado pela IA a partir de um InsightData.
 *
 * Subcomponentes internos: Paragraph, SectionTitle, OrderedList
 * statusStyles: mapeia feasibility.status para label e classes de cor (viable / needs_adjustment / unfeasible)
 
 * Seções renderizadas:
 
 * Viabilidade da Meta  — badge de status + feasibility.content
 *   Diagnóstico Financeiro — diagnosis.content
 *   Sugestões Práticas     — suggestions.items
 *   Como Aumentar sua Renda — extraIncome.items
 *   Sugestões de Investimento — investment.items
 *   Mensagem Final          — motivation.content
 * */
