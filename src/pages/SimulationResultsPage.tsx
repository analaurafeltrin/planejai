 ...
 * Página de resultados da simulação, acessada via /resultado/:id.
 
 * - Recupera o id da URL (useParams) e busca o registro no localStorage (getFormData)
 * - Se não encontrar, exibe mensagem de fallback
 * - Calcula a economia mensal necessária com calcMonthlySavings
 * - Renderiza:
 *   - PageHero com título/subtítulo
 *   - Grid superior (3 cards): meta, prazo e economia mensal (variant primary)
 *   - Grid inferior: AIInsightsCard à esquerda + 3 cards financeiros à direita (renda, custos, dívidas)
 */
